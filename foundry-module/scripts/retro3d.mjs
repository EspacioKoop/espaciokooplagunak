...
//     resuelto conectándolo a producción. La regresión de arriba está fijada
//     como fixture end-to-end sobre la escena real en
//     `retro3d-fundir.test.mjs` (#900) — no solo descrita aquí en prosa: los
//     números exactos varían con el mobiliario de la cantina (no son los
//     mismos que cuando se escribió este párrafo), pero mientras el hueco de
//     revalidación siga abierto, esa prueba exige que al menos un ángulo del
//     barrido siga regresionando. Si algún día no regresiona en ninguno, esa
//     prueba lo señala como la condición para revisar si ya se puede cablear
//     Newell a producción.
//
