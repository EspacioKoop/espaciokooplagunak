...
Investigación cerrada en el issue [#885](https://github.com/VaroTv7/espaciokooplagunak/issues/885):
seis herramientas de uso frecuente en mazmorreo y worldbuilding, evaluadas por si aportan valor al
objetivo **standalone** de Espaciokoop Lagunak ([ADR-0008](adr/) / `docs/ROADMAP_PRODUCTO.md`) y si
su licencia permite port de código, adaptador de formato, solo referencia o descarte. Cada licencia
está verificada contra la fuente oficial (no snippets de buscador), con dos correcciones respecto a
