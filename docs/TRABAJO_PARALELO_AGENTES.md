...
| Módulo: minijuegos | `foundry-module/scripts/minijuegos/**`, https://github.com/VaroTv7/espaciokooplagunak/pull/936`foundry-module/scripts/minijuegos-wiring.mjs` | `node --test $(find foundry-module/tests -name '*.test.mjs')` |
