...
export function limitarPosicionCombate(position = {}, origenCasilla = {}) {
...
export function resolverCamaraTerceraCombate({ x, z, yaw, y = 0, origenCasilla = {} } = {}) {
  const posicion = limitarPosicionCombate({ x, z }, origenCasilla);
  return {
    posicion,
