...
const SALA_A = crearSalaCaja({
  ...
  // Sin piel de casco (#548/#550/#552) en muros, puertas, objetos ni suelo: estas dos salas
...
const SALA_B = crearSalaCaja({ ancho: 6, profundidad: 6, puertas: [{ rect: PUERTA_B_HACIA_A }], muralPixel: false, pielPuertas: false, pielObjetos: false, pielSuelo: false });
