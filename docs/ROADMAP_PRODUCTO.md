...
|---|---|---|---|
| Smoke real multijugador de la integración opcional | **No existe evidencia multijugador registrada**; [#29](https://github.com/VaroTv7/espaciokooplagunak/issues/29) es solo un smoke GUI con GM y excluye clientes | `BLOCKED` | Ejecutar y registrar una validación multijugador específica con clientes conectados |
...
| Automatización limitada para puestos vacíos | [#481](VERIFICACION-NAVEGACION-Y-AUTOMATIZACION.md#481--automatización-nativa-de-puestos-sin-tripulación) demuestra que no existe automatización nativa; [#512](https://github.com/VaroTv7/espaciokooplagunak/issues/512) ya recoge la decisión de degradado con aviso | `BLOCKED` | Formalizar en `main` la decisión de #512 antes de implementarla |
