...
test("espacio de puesto: órdenes operativas y acciones de pie en ese orden", () => {
  ...
  assert.deepEqual(ids, [
    ...
    "lagunak-orden-objetivo-atraque",
    "orden-atracar",
    ...
    "lagunak-orden-waypoint-rumbo",
    "lagunak-orden-waypoint-distancia",
    "orden-waypoint-colocar",
    "lagunak-orden-waypoint-indice",
    "orden-waypoint-mover",
    "orden-waypoint-borrar",
    "lagunak-orden-sonda-rumbo",
    "lagunak-orden-sonda-distancia",
    "orden-sonda-lanzar",
    "lagunak-orden-objetivo-sonda",
    "orden-sonda-enlazar",
    "orden-sonda-desenlazar",
    "orden-alerta-normal",
    "orden-alerta-amarilla",
    "orden-alerta-roja",
    "lagunak-orden-equipo",
    "lagunak-orden-sala-destino",
    "orden-mover-equipo",
